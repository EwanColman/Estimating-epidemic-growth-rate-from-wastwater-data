...
for site in sites:
    ...
    pk.dump(record,open('../pickles/different_sites/'+data_source+'/'+site+'_record_'+str(improvement_threshold)+'.p','wb'))

    print(site,'number of data points:',number_of_data_points)
